...
class QRCode {
  ...
  static QRCode decode(Object result) {
    ...
    return QRCode(value: result[0] as String?);
  }
}
...
class QRScannerApi {
  ...
  Future<QRCode> scanQRCode() async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.native_plugins.QRScannerApi.scanQRCode$pigeonVar_messageChannelSuffix';
    ...
    if (pigeonVar_replyList == null) {
      ...
      return (pigeonVar_replyList[0] as QRCode?)!;
    }
  }
}
